...
PhysicsList::PhysicsList() :
	...
	if (verboseLevel > -1) {
		G4cout << "PhysicsList::Constructor with default list: <" << fEmName
				<< ">" << G4endl;
	}
...
void PhysicsList::AddPhysicsList(const G4String& name) {
	...
	if (name == "emstandard_opt0") {
		...
		description << "      " << "PhysicsList::AddPhysicsList: <" << name
				<< "> is not defined";
		G4Exception("PhysicsList::AddPhysicsList", "electronScattering2_F001",
